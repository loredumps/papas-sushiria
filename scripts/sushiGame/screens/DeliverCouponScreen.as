package sushiGame.screens
{
   ...
   public class DeliverCouponScreen
   {
      ...
      public function DeliverCouponScreen(param1:class_5, param2:Number, param3:Function = null, param4:Boolean = false)
      {
         super();
         this.gameObj = param1;
      ...
      {
         var _loc1_:DeliverCouponScreen = this;
         _loc1_.clip = new deliverCouponMC();
         ...
         _loc1_.customerClip.gotoAndPlay("getcoupon");
         if(_loc1_.gameObj.var_131.getCustomerClipName(_loc1_.customerIndex) == _loc1_.gameObj.var_131.getCustomerClipName(_loc1_.gameObj.var_131.getCustomerIndex(_loc1_.mailpersonName)))
         {
            _loc1_.mailpersonName = "Akari";
         }
         ...
         _loc1_.mailpersonClip.x = _loc1_.customerClip.x - 70.2;
         _loc1_.mailpersonClip.y = _loc1_.customerClip.y;
         _loc1_.clip.holder.addChild(_loc1_.mailpersonClip);
         _loc1_.mailpersonClip.gotoAndPlay("givecoupon");
      ...
      {
         var e:Event = param1;
         var screen:DeliverCouponScreen = this;
         if(screen.clip.currentFrame == 56)
         {
            screen.clip.holder.setChildIndex(screen.customerClip,screen.clip.holder.numChildren - 1);
         }
         else if(screen.clip.currentFrame == 113)
         {
            screen.gameObj.var_127.couponCustomer = screen.customerIndex;
            if(screen.inMenu)
            {
               class_6.method_1("Customer will come in TOMORROW");
               screen.gameObj.var_127.couponDay = screen.gameObj.var_127.currentDay + 1;
            }
            else
            {
               class_6.method_1("Customer will come in TODAY");
               screen.gameObj.var_127.couponDay = screen.gameObj.var_127.currentDay;
            }
            --screen.gameObj.var_127.numCoupons;
         }
         else if(screen.clip.currentFrame == 125)
         {
      ...
      {
         var _loc2_:DeliverCouponScreen = this;
         if(param1)
         {
